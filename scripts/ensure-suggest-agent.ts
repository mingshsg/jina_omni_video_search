...
async function main() {
  ...
  const skillCreateBody = {
    ...
    description:
      'Use for edit-time video metadata research from a saved title. Efficient sourced lookup (Wikipedia, Wikidata, IMDb, or TMDB — whichever covers the work) returns cited year, country, language, type, tags, synopsis, and cast drafts; abstains on ambiguity.',
